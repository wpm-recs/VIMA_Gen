...
from ..tasks.utils.device import pybullet_renderer

# Camera renderer used for every observation / placeholder image.
# ``hardware`` (default) is pybullet's GPU/EGL-accelerated OpenGL path; set
# VIMA_RENDERER=tiny to fall back to the built-in CPU rasteriser.
